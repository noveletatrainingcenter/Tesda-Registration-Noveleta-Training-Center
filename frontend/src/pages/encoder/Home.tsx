  ...
  return (
    <div className="max-w-5xl mx-auto animate-stagger">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm mt-1 text-text-muted">Ready to register new learners today?</p>
      </div>
      ...
      >
        <div>
          <div className="font-bold text-xl text-white mb-1">Register a New Learner</div>
          <div className="text-sm text-white/70">Fill out the TESDA MIS 03-01 Form digitally</div>
        </div>
        <Link
          to="/encoder/register"
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm text-white bg-white/20 hover:bg-white/30 border border-white/30 transition-all"
        >
        ...
        {cards.map((c, i) => (
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <div className="text-xs uppercase tracking-wide mb-1 text-text-muted">
                  {c.label}
                </div>
                <div className="font-bold text-3xl text-text-primary">{c.value}</div>
              </div>
              <div
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs mt-0.5 text-text-muted">{item.desc}</div>
              </div>
            </Link>
          </motion.div>
        ))}
