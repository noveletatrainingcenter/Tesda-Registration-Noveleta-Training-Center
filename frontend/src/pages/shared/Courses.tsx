        ...
        {showConfirm && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50">
            ...
            >
              ...
              <p className="text-sm text-text-muted mb-5">Please confirm the course details are correct.</p>
              <div className="flex justify-end gap-3">
                <button className="btn-ghost" onClick={() => setShowConfirm(false)} disabled={loading}>Cancel</button>
...
export default function Courses() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['courses', page, limit, search, sectorFilter],
    queryFn: () =>
      api.get('/courses', { params: { page, limit, search, sector: sectorFilter } }).then(r => r.data),
  ...
  return (
    <div className="max-w-6xl mx-auto">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="px-4 py-3 text-text-muted font-medium text-xs">Action</th>
              </tr>
            </thead>
            <tbody>
              {isLoading ? (
                ...
                <tr><td colSpan={4} className="text-center py-12 text-text-muted">No courses found.</td></tr>
              ) : courses.map(c => (
                <tr key={c.id} className="border-b border-border last:border-0 hover:bg-bg-input transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1 justify-end">
                      ...
                      <button title="Archive" onClick={() => setArchiving(c)}
      ...
      <AnimatePresence>
        {showForm && (
          <CourseModal course={editing ?? undefined} onClose={() => { setShowForm(false); setEditing(null); }} />
        )}
        {archiving && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            ...
            >
              ...
              <div className="flex justify-end gap-3">
                ...
                <button className="btn-primary bg-red-500 border-red-500 hover:bg-red-600"
                  onClick={() => archiveMut.mutate(archiving.id)} disabled={archiveMut.isPending}>
